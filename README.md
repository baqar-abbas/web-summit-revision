...
| Web Summit |
|---------------------------------------|
|![image](/images/webSummitImage.JPG)|
...
- **[Design and implement the functionality of Homepage]**
- **[Desgin and implement the functionality of About Page]**
- **[Mobile and Desktop responsive css rules included]**
- **[Mobile Popup menu implemented through JavaScript]**
...
```sh
  cd my-folder
  git@github.com:baqar-abbas/web-summit-revision.git
```
<p align="right">(<a href="#readme-top">back to top</a>)</p>
...
- [ ] **[Other Links will be made functional]**
- [ ] **[New functionalities will be incorporated]**
- [ ] **[Exhibition link will be functional]**
